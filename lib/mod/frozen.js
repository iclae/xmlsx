...
Frozen.analysis = function analysis(format) {
  var sheetViews = format.worksheet.sheetViews
  var forzenNumber = 0
  if (sheetViews) {
    forzenNumber = parseInt(format.worksheet.sheetViews[0].sheetView[0].pane[0].$.ySplit, 10)
  }
